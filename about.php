      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/cover1.jpg" alt="Image placeholder" class="img-fluid rounded">
              </figure>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/orang1.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Wan Hayatun Nisa</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/orang2.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Muhammad Dirga</h3>
                  <p class="block-38-subheading">Mahasiswa</p>
                </div>
                <div class="block-38-body">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/orang3.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Misna Pinte Miara</h3>
                  <p class="block-38-subheading">Mahasiswa</p>
                </div>
                <div class="block-38-body">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/orang4.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Nabila Safira Hamdani</h3>
                  <p class="block-38-subheading">Mahasiswa</p>
                </div>
                <div class="block-38-body">
