                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/sop buah.JPG" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Sop Buah</h2>
                    </td>
                    <td>Rp. 25.000,00</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/jus.png" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Jus</h2>
                    </td>
                    <td>Rp. 10.000,00</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
